...
def test_parse_doc_one_line_doc():
    ...
    assert swagger._parse_doc(test_one_line_doc) == ("Some Text Goes Here", None)
...
def test_parse_doc_multi_line_doc():
    ...
    assert extracted[1] == "this is the extra text<br/>and this is the third line."

def test_parse_doc_weird_characters():
    test_weird_characters = MockBasicObject()
    test_weird_characters.__doc__ = "Hi, 297agiu(*#&_$ ! \n Oh, the terrible 2908*&%)(#%#"
