...
@pytest.mark.parametrize("case_name, test_input, expected", 
    [('empty_string', '', ''), 
    ('simple', '/endpoint', '/endpoint'),
    ('single_parameter_no_type', '/path/<parameter>', '/path/{parameter}'),
    ('single_parameter_string', '/<string(length=2):lang_code>', '/{lang_code}'),
    ('multiple_parameters', '/<string(length=3):lang_code>/<string:id>/<float:probability>', '/{lang_code}/{id}/{probability}'),
    ('multiple_parameters_varied_length_string', '/<string(length=5):lang_code>/<string:id>/<float:probability>', '/{lang_code}/{id}/{probability}'),
    ('long_path_single_parameter', 'path/subpath/other_path/<string(length=2):lang_code>', 'path/subpath/other_path/{lang_code}')])
